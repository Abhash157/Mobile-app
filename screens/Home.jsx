...
import { View, Text, StyleSheet, Image, TouchableHighlight, Component } from "react-native";
...
const HomeScreen = () =>(
    ...
    <SafeAreaView style={[styles.container, Elements.centered]}>
        <View style={[styles.profileDetails, Elements.centered]}>
            <View style={styles.profilePictureBox}>
                ...
                <View style={[styles.circle]}>
                    <Image source={require('../assets/images/abhash.jpeg')} style={{
                        height: '100%',
                        width: '100%',
                    }} />
                </View>
            ...
            <View style={styles.profileTextBox}>
                <View style={styles.profileSummary}>
                    <View style={[{
                        ...
                        <Text style={[Elements.flexMe, styles.profileText]}>Grade: Bachelor</Text>
                        <Text style={[Elements.flexMe, styles.profileText]}>Gender: Male</Text>
                    </View>
                    <Text style={[Elements.flexMe, styles.profileText]}>Date: 2024/01/01</Text>
        ...
        <View style={styles.footer}>
            <View style={[styles.footerCollege, {
                flex: 5
            }]}>
                <Image />
